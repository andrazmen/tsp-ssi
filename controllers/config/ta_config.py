...
SCHEMA_ATTR = ["issuer_did", "issuer_cn", "issuer_role", "subject_did", "subject_cn", "subject_role", "subject_device_id", "subject_device_type", "cem_id", "hems_id", "description", "issue_datetime", "credential_type"]
